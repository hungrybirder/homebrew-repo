class JdtLanguageServer < Formula
  ...
  url "https://download.eclipse.org/jdtls/snapshots/jdt-language-server-1.6.0-202110290603.tar.gz"
  sha256 "aa7b0b113187563f891844db1add50eee31ddbd4aee7dc66284728b79a0df780"
